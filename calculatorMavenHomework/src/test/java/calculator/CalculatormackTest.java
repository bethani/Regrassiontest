...
public class CalculatormackTest {
  ...
  @Test
  public void MackTest4() {
  
    System.setProperty("webdriver.chrome.driver",
			"C:\\Users\\Wendifraw\\Downloads\\chromedriver_win32 (2)\\chromedriver.exe");

	WebDriver driver = new ChromeDriver();

	 driver.get("http://api.icraftsoft.net/register/#!");
  }
}
